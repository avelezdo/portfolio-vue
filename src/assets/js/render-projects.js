let myProjects = [
	...
	},
	{
		id: 1011,
		title: 'Drum Machine',
		image: './images/project-images/drum-machine.JPG',
		technologies: ['HTML & CSS', 'SCSS', 'JavaScript'],
		description:
			"Writing and producing music was my first passion - so naturally I couldn't help sampling some of the songs I've written to create this drum machine.",
	...
	},
	{
		id: 2,
		title: 'Ecohabit',
		image: './images/project-images/ecohabit.JPG',
		technologies: ['React.js', 'Material UI', 'Passport', 'Cloudinary', 'Node.js & Express', 'MongoDB'],
	...
	},
	{
		id: 2876,
		title: 'Placespace',
		image: './images/project-images/placespace.JPG',
		technologies: ['Gatsby', 'React.js', 'Tailwind CSS', 'Contentful CMS'],
	...
	},
	{
		...
		image: './images/project-images/quote-generator.JPG',
	...
	},
	{
		id: 1245,
		title: 'Bearclaw',
		image: './images/project-images/bearclaw.JPG',
		technologies: ['HTML & CSS', 'SCSS', 'jQuery', 'PHP', 'MySQL'],
	...
	},
	{
		...
		image: './images/project-images/tfiy.JPG',
		technologies: ['React.js', 'Material UI', 'Node.js/Express', 'Nodemailer'],
	...
	},
	{
		...
		image: './images/project-images/record-store-shopping.JPG',
		technologies: ['React.js'],
	...
	},
	{
		id: 235,
		title: 'Give a GIF',
		image: './images/project-images/give-a-gif.JPG',
		technologies: ['HTML & CSS', 'JavaScript', 'jQuery'],
		description:
			'A web application which uses the Giphy API to generate GIFs on request, where the user can store their favorite GIFs in the local storage.',
	...
	},
	{
		id: 5,
		title: 'Deetz',
		image: './images/project-images/deetz.JPG',
		technologies: ['HTML & CSS', 'jQuery', 'JavaScript', 'SCSS', 'Handlebars', 'MySQL', 'Sequelize', 'Node.js & Express'],
	...
	},
	{
		id: 8,
		title: 'Medo',
		image: './images/project-images/medo.JPG',
		technologies: ['HTML & CSS', 'JavaScript', 'jQuery', 'Animate.css', 'Firebase', 'Moment.js'],
		description:
			"It's the age of content, and we've all got too many recommendations from friends. Allow Medo to be the central place where you can organize all of those things you've been meaning to check out!",
