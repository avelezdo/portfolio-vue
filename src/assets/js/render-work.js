const myJobs = [
	{
		...
		production_link: '',
		description:
			"I was brought onto this project to bring a UI design to life. Recruiting software in its development phase, Bearclaw needed a frontend-focused developer to improve the application's design and the user experience.",
		bullets: [
	...
	},
	{
		...
		description:
			"Through Bootcamp, I was connected with the owner of a dance studio who asked me to develop a beautiful website for her new business. I was on a roll with learning React at the time, and didn't want this opportunity to stop me in my tracks.",
		bullets: [
	...
	},
	{
		...
		description:
			'A small software company that helps used motor part sellers better manage eBay accounts, I was hired to re-design the home page of the website.',
		bullets: [],
	},
	{
		...
		production_link: 'https://salvageboy.com',
		description:
			'I started with HearingLife as coordinator in 2018, and got promoted to email/web around the time I enrolled at bootcamp. While not a "developer" by job title, in 2020 I spearheaded the marketing team\'s effort to integrate the Podium Reviews API on our over 400 location web pages. This included:',
		bullets: [
